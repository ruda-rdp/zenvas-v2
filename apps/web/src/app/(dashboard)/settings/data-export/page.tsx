  ...
  return (
    <div className="p-8 max-w-3xl">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">Export your workspace data</p>
      </div>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-100 rounded-xl p-8 text-center">
        ...
        <p className="text-gray-600 mb-6">
          Data export functionality will be available soon. You&apos;ll be able to:
        </p>
        <ul className="text-left max-w-md mx-auto space-y-2 text-sm text-gray-600 mb-6">
          <li className="flex items-start gap-2">
            <span>✓</span>
            <span>Export all clients and contacts</span>
          </li>
          <li className="flex items-start gap-2">
            <span>✓</span>
            <span>Export projects and tasks</span>
          </li>
          <li className="flex items-start gap-2">
            <span>✓</span>
            <span>Download invoices and documents</span>
          </li>
          <li className="flex items-start gap-2">
            <span>✓</span>
            <span>Export in CSV, JSON, or PDF format</span>
          </li>
        </ul>
        <Link
          href="/settings"
