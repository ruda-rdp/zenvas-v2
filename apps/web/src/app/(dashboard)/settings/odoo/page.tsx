  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-1">Manage synchronization with your Odoo accounting system</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow border border-gray-200 p-6 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                {status.connection.isConnected
                  ...
                  : "Unable to reach your Odoo instance. Check credentials."}
              </p>
            </div>
          </div>
          <button
        ...
        <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-200 text-sm">
          <div>
            ...
            <code className="text-gray-900">{status.connection.url}</code>
          </div>
          <div>
          ...
          <div>
            ...
            <code className="text-gray-900">{status.connection.hasApiKey ? "•••• configured" : "⚠️ Missing"}</code>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white rounded-xl shadow border border-gray-200 p-4">
          ...
          <div className="text-sm text-gray-500">Synced to Odoo</div>
        </div>
        <div className="bg-white rounded-xl shadow border border-gray-200 p-4">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
        ...
        <ul className="text-sm text-blue-800 space-y-1 list-disc list-inside">
          ...
          <li>When an order is confirmed, a Down Payment (DP) invoice is created (50% of service price)</li>
          <li>When a project delivery is approved, a Final invoice is created</li>
          <li>All sync operations are logged to Activity Log for audit trail</li>
          <li>You can manually re-sync any client from this page</li>
        </ul>
      </div>
    </div>
  );
